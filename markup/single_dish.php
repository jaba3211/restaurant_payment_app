            ...
            <div class="container">
                <div class="d-flex align-items-center flex-column main-comps-container">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="color: #153a1e;">ბურგერი</h5>
                            <p class="card-text">ფუნთუშა, მაიონეზი, პომიდორი, ცოცხ. კიტრი 2ც, სალათი აისბერგი,
                                კარტოფილის ფილე 2ც .</p>
                            <h4 class="card-text" style="color: #f4c553">30₾</h4>
                            <a href="#" class="btn" style="background: #153a1e; color:#fff;">კალათაში დამატება</a>
                        </div>
                    </div>
                    <a href="busket.html" class="btn" style="background: #f4c553; color:#fff;">შეკვეთის ნახვა</a>
                </div>
            </div>
