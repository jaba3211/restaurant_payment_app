                    ...
                    <div class="card w-100 mb-3" style="background:#f2d4812e;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between flex-wrap">
                                <h5 class="card-title text-danger">Table 1</h5>
                                <h6 class="card-subtitle mb-2 text-muted">21/05/2022 22:07</h6>
                            </div>
                            <p class="fw-bold">Ordered by <span class="text-success">Mariam</span></p>
                            <a href="#" class="card-link fw-bold d-block" style="color:#eaaa13;">See
                                Order Details</a>
                        </div>
                    </div>
