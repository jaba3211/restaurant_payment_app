                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="add_restaurant.php">რესტორნის დამატება</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="add_dish.php">მენიუში კერძის დამატება</a>
                            </li>
            ...
            <div class="container">
                <div class="d-flex align-items-center flex-column main-comps-container">
                    ...
                    <form action="#" method="POST" class="w-100">
                        ...
                        <div class="form-group mb-3">
                            <label for="about_restaurant" class="form-label">რესტორნის შესახებ</label>
                            <textarea  class="form-control" name="about_restaurant" id="about_restaurant" rows="5">
                            </textarea>
                        </div>
