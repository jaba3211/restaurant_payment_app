        ...
        <div class="container-fluid">
            <div class="container">
                <div class="d-flex align-items-center flex-column main-comps-container">
                    ...
                    <div
                        class="dishes d-flex align-items-center w-100 card mb-3 shadow-sm flex-row single_order_product">
                        <span>
                        ...
                        <span class="menu_cat_name ms-3 fw-bold">
                            <div class="text-warning">
                                ...
                                <div class="dish_price">
                                    <p class="raodenoba text-dark">რაოდენობა: <span class="text-success">2</span></p>
                    ...
                    <div
                        ...
                        <span class="menu_cat_name ms-3 fw-bold">
                            <div class="text-warning">
                                პიცა
                                <div class="dish_price">
                                    <p class="raodenoba text-dark">რაოდენობა: <span class="text-success">3</span></p>
                                    <span class="price_sum">150</span>
                                    <span>₾</span>
                                </div>
                            </div>
                ...
                <div class="order_price mt-3 fs-3">
                    შეკვეთის ჯამი: <span class="text-danger fw-bold">350₾</span>
                </div>
                <a class="btn btn-danger mt-3">შეკვეთის წაშლა</a>
            </div>
