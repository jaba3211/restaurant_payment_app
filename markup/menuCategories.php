                ...
                <div class="d-flex align-items-center flex-column main-comps-container">
                    ...
                    <div class="menu_category d-flex justify-content-between align-items-center w-100 card mb-3 p-3 shadow-sm">
                        <span class="menu_cat_icon">
                            <img src="images/hot_dishes.png" alt="" class="img-fluid" width="100">
                        </span>
                    ...
                    <div class="menu_category d-flex justify-content-between align-items-center w-100 card mb-3 p-3 shadow-sm">
                        <span class="menu_cat_icon">
                            <img src="images/sauces.png" alt="" class="img-fluid" width="100">
                        </span>
                        <span class="menu_cat_name fs-3">
                           სოუსები
                        </span>
                    ...
                    <div class="menu_category d-flex justify-content-between align-items-center w-100 card mb-3 p-3 shadow-sm">
                        <span class="menu_cat_icon">
                            <img src="images/drinks.png" alt="" class="img-fluid" width="100">
                        </span>
                        <span class="menu_cat_name fs-3">
                           სასმელები
                        </span>
